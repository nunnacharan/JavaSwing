...
<head>
  <meta charset="UTF-8">
  <title>RTC Ticket Booking</title>
  <style>
    body {
...
<body background="https://cdn.britannica.com/37/123137-050-B5AA0969/trolleybus-Belgrade-Serbia.jpg"> <!-- Path to your train background image -->
  <div class="container">
    <h1>RTC Ticket Booking</h1>
    <form>
